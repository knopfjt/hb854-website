...
```{r prog-rehab-01, fig.cap="Homes served by Weatherization Assistance Program"} 
if (knitr::is_html_output()) {
knitr::include_url(url =
"https://public.tableau.com/views/HB854-AnalysisofExistingPrograms-WAP/wap_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/prog-rehab-01.png")}
```
...
```{r prog-rehab-02, fig.cap="Homes served by Indoor Plumbing Rehabilitation program"} 
if (knitr::is_html_output()) {
knitr::include_url(url =
"https://public.tableau.com/views/HB854-AnalysisofExistingPrograms-IPR/ipr_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/prog-rehab-02.png")}
```
...
```{r prog-rehab-03, fig.cap="Housing units lacking plumbing facilities in Virginia"} 
if (knitr::is_html_output()) {
knitr::include_url(url =
"https://public.tableau.com/views/HB854-AnalysisofExistingPrograms-Housingunitslackingplumbingfacilities/plumb_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/prog-rehab-03.png")}
```
