...
```{r instab-01, fig.cap="Difficulty paying for usual household expenses during COVID-19"} 
if (knitr::is_html_output()) {
knitr::include_url(url =
"https://public.tableau.com/views/HB854-HousingInstabilityandHomelessness-DifficultypayingforusualhouseholdexpensesduringCOVID-19/expense_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/instab-01.png")}
```
...
```{r instab-02, fig.cap="Housing insecurity during COVID-19"} 
if (knitr::is_html_output()) {
knitr::include_url(url =
"https://public.tableau.com/views/HB854-HousingInstabilityandHomelessness-HousinginsecurityduringCOVID-19/hinsec_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/instab-02.png")}
```
...
```{r instab-03, fig.cap="Mortgage delinquency in Virginia"} 
if (knitr::is_html_output()) {
knitr::include_url(url =
"https://public.tableau.com/views/HB854-HousingInstabilityandHomelessness-MortgagedelinquencyinVirginia/dlq_st_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/instab-03.png")}
```
...
```{r instab-04, fig.cap="Mortgage delinquency by region"} 
if (knitr::is_html_output()) {
knitr::include_url(url =
"https://public.tableau.com/views/HB854-HousingInstabilityandHomelessness-Mortgagedelinquencybyregion/dlq_rg_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/instab-04.png")}
```
...
```{r instab-05, fig.cap="Eviction rate in Virginia"} 
if (knitr::is_html_output()) {
knitr::include_url(url =
"https://public.tableau.com/views/HB854-HousingInstabilityandHomelessness-EvictionrateinVirginia/evictrate_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/instab-05.png")}
```
...
```{r instab-06, fig.cap="Statewide eviction filings since January 2019"} 
if (knitr::is_html_output()) {
knitr::include_url(url =
"https://public.tableau.com/views/HB854-HousingInstabilityandHomelessness-StatewideevictionfilingssinceJanuary2019/filings_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/instab-06.png")}
```
...
```{r instab-07, fig.cap="Point-in-Time homelessness count for Virginia"} 
if (knitr::is_html_output()) {
knitr::include_url(url =
...
} else {knitr::include_graphics("img/instab-07.png")}
```
...
```{r instab-08, fig.cap="Point-in-Time homelessness count by race"} 
if (knitr::is_html_output()) {
knitr::include_url(url =
"https://public.tableau.com/views/HB854-HousingInstabilityandHomelesness-Point-in-Timecountbyrace/pit_race_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/instab-08.png")}
```
...
```{r instab-09, fig.cap="School-age children experiencing homelessness in Virginia"} 
if (knitr::is_html_output()) {
knitr::include_url(url =
"https://public.tableau.com/views/HB854-HousingInstabilityandHomelesness-School-agechildrenexperiencinghomelessnessinVirginia/mckvento_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/instab-09.png")}
```
...
```{r instab-10, fig.cap="Demand for supportive housing in Virginia"} 
if (knitr::is_html_output()) {
knitr::include_url(url = 
"https://public.tableau.com/views/HB854-HousingInstabilityandHomelessness-Virginiassupportivehousingneed/shneed_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/instab-10.png")}
```
...
```{r instab-11, fig.cap="Subpopulations experiencing declines in observed homelessness"} 
if (knitr::is_html_output()) {
knitr::include_url(url =
"https://public.tableau.com/views/HB854-HousingInstabilityandHomelesness-Subpopulationsexperiencingdeclinesinhomelessness/pit_sub_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/instab-11.png")}
```
...
```{r instab-12, fig.cap="Point-in-Time count and permanent supportive housing beds"} 
if (knitr::is_html_output()) {
knitr::include_url(url =
"https://public.tableau.com/views/HB854-HousingInstabilityandHomelessness-Point-in-Timecountandpermanentsupportivehousingbeds/pit_psh_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/instab-12.png")}
```
