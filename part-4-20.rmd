...
```{r prog-rental-01, fig.cap="LIHTC allocation and units funded"} 
if (knitr::is_html_output()) {
knitr::include_url(url =
"https://public.tableau.com/views/HB854-VHLIHTC/vh_lihtc_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/prog-rental-01.png")}
```
...
```{r prog-rental-02, fig.cap="Profile of LIHTC households"} 
if (knitr::is_html_output()) {
knitr::include_url(url =
"https://public.tableau.com/views/HB854-LIHTCtenants/lihtc_profile_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/prog-rental-02.png")}
```
...
```{r prog-rental-03, fig.cap="Cost-burdened renters by AMI and LIHTC units"} 
if (knitr::is_html_output()) {
knitr::include_url(url =
"https://public.tableau.com/views/HB854-LIHTCvsCost-burdenedrenters/lihtc_cb_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/prog-rental-03.png")}
```
