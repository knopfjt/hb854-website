...
```{r, bondallocation, echo=FALSE}

library(tidyverse)
library(kableExtra)

bondallocation <- read.csv("data/bondallocation.csv")

if (knitr::is_html_output()) {

  knitr::kable(bondallocation,
               format = "html",
               caption = "Statutory bond allocation by pool according to Va. Code Ann. § 15.2-5002"
               ) %>%
...
```{r bond-01, fig.cap="Private Activity Bond use trends in Virginia"}
if (knitr::is_html_output()) {
knitr::include_url(url =
"https://public.tableau.com/views/HB854-BondFinancing-VirginiaPrivateActivityBonds/pool_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/bond-01.png")}
```
...
```{r bond-02, fig.cap="Share of annual PAB allocation for housing uses"}
if (knitr::is_html_output()) {
knitr::include_url(url =
"https://public.tableau.com/views/HB854-BondFinancing-VirginiaPrivateActivityBondsuse/Dashboard3?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/bond-02.png")}
```
