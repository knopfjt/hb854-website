# Projections {#part-3-projections}
...
```{r proj-01, fig.cap="Statewide population counts and projections"} 
if (knitr::is_html_output()) {
knitr::include_url(url =
"https://public.tableau.com/views/HB854-Projections-Statewidepopulationcountsandprojections/est_proj_st_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/proj-01.png")}
```
...
```{r proj-02, fig.cap="Population projections by market group"} 
if (knitr::is_html_output()) {
knitr::include_url(url =
"https://public.tableau.com/views/HB854-Projections-Populationprojectionsbymarketgroup/est_proj_mg_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/proj-02.png")}
```
...
```{r proj-03, fig.cap="Population projections by market name"} 
if (knitr::is_html_output()) {
knitr::include_url(url =
"https://public.tableau.com/views/HB854-Projections-Populationprojectionsbymarketname/proj_mn_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/proj-03.png")}
```
...
```{r proj-04, fig.cap="Population projections by submarket"} 
if (knitr::is_html_output()) {
knitr::include_url(url =
"https://public.tableau.com/views/HB854-Projections-Populationprojectionsbysubmarket/proj_sb_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/proj-04.png")}
```
...
```{r proj-05, fig.cap="Population projections by age group"} 
if (knitr::is_html_output()) {
knitr::include_url(url =
"https://public.tableau.com/views/HB854-Projections-Populationprojectionsbyagegroup/age_proj_st_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/proj-05.png")}
```
...
```{r proj-06, fig.cap="Population projections by age group and market group"} 
if (knitr::is_html_output()) {
knitr::include_url(url =
"https://public.tableau.com/views/HB854-Projections-Populationprojectionsbyagegroupandmarketgroup/age_proj_mg_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/proj-06.png")}
```
