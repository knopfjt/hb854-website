...
```{r rental-01, fig.cap="Renter household types"}
if (knitr::is_html_output()) {
knitr::include_url(url =
"https://public.tableau.com/views/HB854-Homeowership-Renterhouseholdtypes/hhtype_mg_rent_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/rental-01.png")}
```
...
```{r rental-02, fig.cap="Renter household size"}
if (knitr::is_html_output()) {
knitr::include_url(url =
"https://public.tableau.com/views/HB854-Rental-Renterhouseholdsize/hhsize_mg_rent_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/rental-02.png")}
```
...
```{r rental-03, fig.cap="Renter household age"}
if (knitr::is_html_output()) {
knitr::include_url(url =
"https://public.tableau.com/views/HB854-Renter-Renterhouseholderage/hhage_mg_rent_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/rental-03.png")}
```
...
```{r rental-04, fig.cap="Renter race and ethnicity"}
if (knitr::is_html_output()) {
knitr::include_url(url =
"https://public.tableau.com/views/HB854-Rental-Renterraceandethnicity/hhrace_mg_rent_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/rental-04.png")}
```
...
```{r rental-05, fig.cap="Renter household income"}
if (knitr::is_html_output()) {
knitr::include_url(url =
"https://public.tableau.com/views/HB854-Rental-Renterhouseholdincome/hhinc_mg_rent_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/rental-05.png")}
```
...
```{r rental-06, fig.cap="Renter educational attainment"}
if (knitr::is_html_output()) {
knitr::include_url(url =
"https://public.tableau.com/views/HB854-Rental-Rentereducationalattainment/ed_rent_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/rental-06.png")}
```
...
```{r rental-07, fig.cap="Change in gross rent"}
if (knitr::is_html_output()) {
knitr::include_url(url =
"https://public.tableau.com/views/HB854-Rental-Changeingrossrent/gr_mg_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/rental-07.png")}
```
...
```{r rental-08, fig.cap="Median gross rent and median renter income"}
if (knitr::is_html_output()) {
knitr::include_url(url =
"https://public.tableau.com/views/HB854-Rental-Mediangrossrentandmedianrenterincome/rent_inc_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/rental-08.png")}
```
...
```{r rental-09, fig.cap="Rental vacancy rates"}
if (knitr::is_html_output()) {
knitr::include_url(url =
"https://public.tableau.com/views/HB854-Rental-RentalvacancyratesinVirginia/vacancy_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/rental-09.png")}
```
...
```{r rental-10, fig.cap="Rental vacancy rates by state"}
if (knitr::is_html_output()) {
knitr::include_url(url =
"https://public.tableau.com/views/HB854-Rental-Rentalvacancyratestates/vac_st_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/rental-10.png")}
```
...
```{r rental-11, fig.cap="Renter housing units by structure type"}
if (knitr::is_html_output()) {
knitr::include_url(url =
"https://public.tableau.com/views/HB854-Rental-Rentalhousingunitsbystructuretype/renter_structure_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/rental-11.png")}
```
...
```{r rental-12, fig.cap="Renter cost burden by race and ethnicity"}
if (knitr::is_html_output()) {
knitr::include_url(url =
"https://public.tableau.com/views/HB854-Rental-Rentercostburdenbyraceandethnicity/cb_race_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/rental-12.png")}
```
...
```{r rental-13, fig.cap="Renter cost burden by household type"}
if (knitr::is_html_output()) {
knitr::include_url(url =
"https://public.tableau.com/views/HB854-Rental-Rentercostburdenbyhouseholdtype/cb_hhtype_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/rental-13.png")}
```
...
```{r rental-14, fig.cap="Renter cost burden by income"}
if (knitr::is_html_output()) {
knitr::include_url(url =
"https://public.tableau.com/views/HB854-Rental-Rentercostburdenbyincome/cb_income_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/rental-14.png")}
```
...
```{r rental-15, fig.cap="Renter housing affordability match"}
if (knitr::is_html_output()) {
knitr::include_url(url =
"https://public.tableau.com/views/HB854-Rental-Renterhousingaffordabilitymatch/match_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/rental-15.png")}
```
...
```{r rental-16, fig.cap="Federally-supported rental units in Virginia"}
if (knitr::is_html_output()) {
knitr::include_url(url =
"https://public.tableau.com/views/HB854-Rental-Federally-supportedrentalunitsinVirginia/subsidy_owner_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/rental-16.png")}
```
...
```{r rental-17, fig.cap="Expiring LIHTC affordability restrictions in Virginia"}
if (knitr::is_html_output()) {
knitr::include_url(url =
"https://public.tableau.com/views/HB854-Rental-ExpiringLIHTCaffordabilityrestrictionsinVirginia/expiration_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/rental-17.png")}
```
...
```{r rental-18, fig.cap="Housing Choice Vouchers in Virginia"}
if (knitr::is_html_output()) {
knitr::include_url(url =
"https://public.tableau.com/views/HB854-Rental-HousingChoiceVouchersinVirginia/hcv_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/rental-18.png")}
```
...
```{r rental-19, fig.cap="Demand for Housing Choice Vouchers in Virginia"}
if (knitr::is_html_output()) {
knitr::include_url(url =
"https://public.tableau.com/views/HB854-Rental-WaitinglistsandvoucherrecipientsinVirginia/waitinglist_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/rental-19.png")}
```
