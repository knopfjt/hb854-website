# Provider survey {#part-2-providersurvey}
...
```{r survey-01, fig.cap="Geographic representation of respondents"}
if (knitr::is_html_output()) {
knitr::include_url(url = "https://public.tableau.com/views/HB854HousingProviderSurvey-GeographicRepresentation/HB854GeoRep?:showVizHome=no&:embed=true", height = "500px")
} else {
knitr::include_graphics("img/survey-01.png")
}
```
...
```{r survey-04, fig.cap="Regional representation of survey responses and population"}
if (knitr::is_html_output()) {
knitr::include_url(url = "https://public.tableau.com/views/HB854-ProviderSurvey-RegionalRepresentation/responses_pop_db?:showVizHome=no&:embed=true", height = "500px")
} else {
knitr::include_graphics("img/survey-04.png")
}
```
...
```{r survey-02, fig.cap="Organizational representation of respondents"}
if (knitr::is_html_output()) {
knitr::include_url(url = "https://public.tableau.com/views/HB854HousingProviderSurvey-OrganizationalRepresentation/HB854OrgCat?:showVizHome=no&:embed=true", height = "500px")
} else {
knitr::include_graphics("img/survey-02.png")
}
```
...
```{r survey-03, fig.cap="Housing area served by respondent"}
if (knitr::is_html_output()) {
knitr::include_url(url = "https://public.tableau.com/views/HB854HousingProviderSurvey-HousingAreaRepresentation/HB854HousingArea?:showVizHome=no&:embed=true", height = "500px")
} else {
knitr::include_graphics("img/survey-03.png")
}
```
...
```{r survey-05, fig.cap="Housing issues identified by respondents"}
if (knitr::is_html_output()) {
knitr::include_url(url = "https://public.tableau.com/views/HB854HousingProviderSurvey-Housingissues/HousingIssues?:showVizHome=no&:embed=true", height = "500px")
} else {
knitr::include_graphics("img/survey-05.png")
}
```
...
```{r survey-08, fig.cap="Programs used by respondents"}
if (knitr::is_html_output()) {
knitr::include_url(url = "https://public.tableau.com/views/HB854HousingProviderSurvey-ProgramUse/Programuse?:showVizHome=no&:embed=true", height = "500px")
} else {
knitr::include_graphics("img/survey-08.png")
}
```
...
```{r survey-09, fig.cap="Program area effectiveness and need for improvement"}
if (knitr::is_html_output()) {
knitr::include_url(url = "https://public.tableau.com/views/HB854HousingProviderSurvey-Programeffectivenessandimprovement/Effectivenessandimprovement?:showVizHome=no&:embed=true", height = "500px")
} else {
knitr::include_graphics("img/survey-09.png")
}
```
...
```{r survey-10, fig.cap="Program challenges faced by users"}
if (knitr::is_html_output()) {
knitr::include_url(url = "https://public.tableau.com/views/HB854HousingProviderSurvey-Programchallenges/Challenges?:showVizHome=no&:embed=true", height = "500px")
} else {
knitr::include_graphics("img/survey-10.png")
}
```
...
```{r survey-06, fig.cap="Perceived significance of racial disparities in housing"}
if (knitr::is_html_output()) {
knitr::include_url(url = "https://public.tableau.com/views/HB854HousingProviderSurvey-Perceivedsignificanceofracialdisparitiesinhousing/RacialDisparities?:showVizHome=no&:embed=true", height = "500px")
} else {
knitr::include_graphics("img/survey-06.png")
}
```
...
```{r survey-12, fig.cap="Program ability to address racial inequities in housing"}
if (knitr::is_html_output()) {
knitr::include_url(url = "https://public.tableau.com/views/HB854HousingProviderSurvey-Program-Addressracialinequity/Program-CovidandRace2?:showVizHome=no&:embed=true", height = "500px")
} else {
knitr::include_graphics("img/survey-12.png")
}
``` 
...
```{r survey-07, fig.cap="Housing area concern due to COVID-19"}
if (knitr::is_html_output()) {
knitr::include_url(url = "https://public.tableau.com/views/HB854HousingProviderSurvey-HousingareaconcernduetoCOVID-19/COVID-19?:showVizHome=no&:embed=true", height = "500px")
} else {
knitr::include_graphics("img/survey-07.png")
}
```
...
```{r survey-13, fig.cap="Service disruption due to COVID-19"}
if (knitr::is_html_output()) {
knitr::include_url(url = "https://public.tableau.com/views/HB854HousingProviderSurvey-Coviddisruption/Disruptions?:showVizHome=no&:embed=true", height = "500px")
} else {
knitr::include_graphics("img/survey-13.png")
}
```
...
```{r survey-14, fig.cap="Concerns about COVID-19"}
if (knitr::is_html_output()) {
knitr::include_url(url = "https://public.tableau.com/views/HB854HousingProviderSurvey-COVIDconcerns/Concerns?:showVizHome=no&:embed=true", height = "500px")
} else {
knitr::include_graphics("img/survey-14.png")
}
```

```{r survey-11, fig.cap="Negative impact of COVID-19"}
if (knitr::is_html_output()) {
knitr::include_url(url = "https://public.tableau.com/views/HB854HousingProviderSurvey-Program-COVIDimpact/Program-CovidandRace?:showVizHome=no&:embed=true", height = "500px")
} else {
knitr::include_graphics("img/survey-11.png")
}
```
...
```{r survey-15, fig.cap="Importance of resources to overcome COVID-19"}
if (knitr::is_html_output()) {
knitr::include_url(url = "https://public.tableau.com/views/HB854HousingProviderSurvey-COVIDresources/Resources?:showVizHome=no&:embed=true", height = "500px")
} else {
knitr::include_graphics("img/survey-15.png")
}
```
