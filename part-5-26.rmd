...
```{r state-rent-01, fig.cap="Profile of public housing residents and HCV recipients"}
if (knitr::is_html_output()) {
knitr::include_url(url =
"https://public.tableau.com/views/HB854-ProfileofPHresidentsandvoucherrecipients/story?:showVizHome=no&:embed=true", height = "700px")
} else {knitr::include_graphics("img/state-rent-01.png")}
```
...
rentscenarios <- read.csv("data/rentscenarios.csv")

if (knitr::is_html_output()) {

  knitr::kable(rentscenarios,
               format = "html",
               caption = "Possible funding scenarios for new state-funded rental assistance program"
               ) %>%
