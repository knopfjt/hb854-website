...
```{r utility-01, fig.cap="Energy cost burden in Virginia by poverty level"}
if (knitr::is_html_output()) {
knitr::include_url(url =
"https://public.tableau.com/views/HB854-UtilityRateReduction-EnergyburdenbyFPL/eb_fpl_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/utility-01.png")}
```
...
```{r utility-02, fig.cap="Energy cost burden by tenure, structure type, and AMI"}
if (knitr::is_html_output()) {
knitr::include_url(url =
"https://public.tableau.com/views/HB854-Energycostburden/bt_t_ami_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/utility-02.png")}
```
...
```{r utility-03, fig.cap="Energy cost burden by tenure, year home built, and AMI"}
if (knitr::is_html_output()) {
knitr::include_url(url =
"https://public.tableau.com/views/HB854-Energycostburden/yb_t_ami_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/utility-03.png")}
```
...
```{r utility-04, fig.cap="Average retail price of electricity by sector in Virginia"}
if (knitr::is_html_output()) {
knitr::include_url(url =
"https://public.tableau.com/views/HB854-UtilityRateReduction-Electricityprice/elxprice_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/utility-04.png")}
```
...
```{r utility-05, fig.cap="Residential water and wastewater bills in Virginia"}
if (knitr::is_html_output()) {
knitr::include_url(url =
"https://public.tableau.com/views/HB854-Waterandwastewater/avgbill_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/utility-05.png")}
```
...
```{r utility-06, fig.cap="Households without internet in Virginia"}
if (knitr::is_html_output()) {
knitr::include_url(url =
"https://public.tableau.com/views/HB854-UtilityRateReduction-Internetaccess/internet_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/utility-06.png")}
```
...
```{r utility-07, fig.cap="Water and wastewater hookup fees in Virginia"}
if (knitr::is_html_output()) {
knitr::include_url(url =
"https://public.tableau.com/views/HB854-UtilityRateReduction-Waterandwastewaterfees/cf_crc_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/utility-07.png")}
```
...
devfees <- read_csv("data/devfees.csv")

if (knitr::is_html_output()) {

  knitr::kable(devfees,
               format = "html",
               caption = "Examples of local development fees for two residential projects from the City of Fairfax"
               ) %>%
...
```{r utility-08, fig.cap="Sample monthly energy costs for all-electric multifamily building"}
if (knitr::is_html_output()) {
knitr::include_url(url =
"https://public.tableau.com/views/HB854-LIHTCenergycosts/engcost_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/utility-08.png")}
```
