...
```{r demog-01, fig.cap="Total population of Virginia"}
if (knitr::is_html_output()) {
knitr::include_url(url = "https://public.tableau.com/views/HB854-Demographics-PopulationEstimates2020/pop_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/demog-01.png")}
```
...
```{r demog-02, fig.cap="Population change by market name"}
if (knitr::is_html_output()) {
knitr::include_url(url = "https://public.tableau.com/views/HB854-Demographics-Populationchangebymarketname/pop_chg_mg_mn_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/demog-02.png")}
```
...
```{r demog-03, fig.cap="Population change by submarket"}
if (knitr::is_html_output()) {
knitr::include_url(url = "https://public.tableau.com/views/HB854-Demographics-Populationchangebysubmarket/pop_chg_sb_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/demog-03.png")}
```
...
```{r demog-04, fig.cap="Components of population change"}
if (knitr::is_html_output()) {
knitr::include_url(url = "https://public.tableau.com/views/HB854-Demographics-Componentsofpopulationchange/components_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/demog-04.png")}
```
...
```{r demog-05, fig.cap="Components of population change by market group"}
if (knitr::is_html_output()) {
knitr::include_url(url = "https://public.tableau.com/views/HB854-Demographics-Componentsofpopulationchangebymarketgroup/components_mg_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/demog-05.png")}
```
...
```{r demog-06, fig.cap="Components of population change by market name"}
if (knitr::is_html_output()) {
knitr::include_url(url = "https://public.tableau.com/views/HB854-Demographics-Componentsofpopulationchangebymarketname/components_mn_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/demog-06.png")}
```
...
```{r demog-07, fig.cap="Non-white population change"}
if (knitr::is_html_output()) {
knitr::include_url(url = "https://public.tableau.com/views/HB854-Demographics-Non-whitepopulationchange/pop_chg_race_mg_db2?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/demog-07.png")}
```
...
```{r demog-08, fig.cap="Population change by race"}
if (knitr::is_html_output()) {
knitr::include_url(url = "https://public.tableau.com/views/HB854-Demographics-Populationchangebyrace/pop_chg_race_db2?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/demog-08.png")}
```
...
```{r demog-09, fig.cap="Population change by race"}
if (knitr::is_html_output()) {
knitr::include_url(url = "https://public.tableau.com/views/HB854-Demographics-Populationchangebyethnicity/pop_chg_hisp_mg_db2?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/demog-09.png")}
```
...
```{r demog-10, fig.cap="Immigrant population change"}
if (knitr::is_html_output()) {
knitr::include_url(url = "https://public.tableau.com/views/HB854-Immigrantpopulationchange/citizenship_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/demog-10.png")}
```
...
```{r demog-11, fig.cap="Change in foreign-born population in neighboring states"}
if (knitr::is_html_output()) {
knitr::include_url(url = "https://public.tableau.com/views/HB854-Immigrantpopulationchangeinneighboringstates/fb_state_comp_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/demog-11.png")}
```
...
```{r demog-12, fig.cap="Change in population by age group"}
if (knitr::is_html_output()) {
knitr::include_url(url = "https://public.tableau.com/views/HB854-Demographics-Changeinpopulationbyagegroup/age_chg_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/demog-12.png")}
```
...
```{r demog-13, fig.cap="Median age in cities and counties"}
if (knitr::is_html_output()) {
knitr::include_url(url = "https://public.tableau.com/views/HB854-Demographics-Medianageincitiesandcounties/medage_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/demog-13.png")}
```
...
```{r demog-14, fig.cap="Percent change in age group"}
if (knitr::is_html_output()) {
knitr::include_url(url = "https://public.tableau.com/views/HB854-Demographics-Percentchangeinagegroup/age_mg_chg_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/demog-14.png")}
```
...
```{r demog-15, fig.cap="Living arrangements of Virginia’s seniors"}
if (knitr::is_html_output()) {
knitr::include_url(url = "https://public.tableau.com/views/HB854-Demographics-LivingarrangementsofVirginiasseniors/sen_la_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/demog-15.png")}
```
...
```{r demog-16, fig.cap="Share of seniors with a disability"}
if (knitr::is_html_output()) {
knitr::include_url(url = "https://public.tableau.com/views/HB854-Demographics-Shareofseniorswithadisability/sen_dis_mn_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/demog-16.png")}
```
...
```{r demog-17, fig.cap="Younger population by race and ethnicity"}
if (knitr::is_html_output()) {
knitr::include_url(url = "https://public.tableau.com/views/HB854-Demographics-Youngerpopulationbyraceandethnicity/youth_race_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/demog-17.png")}
```
...
```{r demog-18, fig.cap="Change in household size"}
if (knitr::is_html_output()) {
knitr::include_url(url = "https://public.tableau.com/views/HB854-Demographics-Changeinhouseholdsize/hhsize_chg_mg_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/demog-18.png")}
```
...
```{r demog-19, fig.cap="Average household size by tenure"}
if (knitr::is_html_output()) {
knitr::include_url(url = "https://public.tableau.com/views/HB854-Demographics-Averagehouseholdsizebytenure/hhsize_tenure_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/demog-19.png")}
```
...
```{r demog-20, fig.cap="Change in living arrangements"}
if (knitr::is_html_output()) {
knitr::include_url(url = "https://public.tableau.com/views/HB854-Demographics-Changeinlivingarrangements/la_chg_mg_db3?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/demog-20.png")}
```
...
```{r demog-21, fig.cap="Household formation by age group and tenure"}
if (knitr::is_html_output()) {
knitr::include_url(url = "https://public.tableau.com/views/HB854-Demographics-Householdformationbyagegroupandtenure/hhage_tenure_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/demog-21.png")}
```
...
```{r demog-22, fig.cap="Change in households by age group and tenure"}
if (knitr::is_html_output()) {
knitr::include_url(url = "https://public.tableau.com/views/HB854-Demographics-Changeinhouseholdsbyagegroupandtenureandmarketgroup/hhage_tenure_mg_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/demog-22.png")}
```
...
```{r demog-23, fig.cap="Household growth by race and ethnicity and tenure"}
if (knitr::is_html_output()) {
knitr::include_url(url = "https://public.tableau.com/views/HB854-Demographics-Householdgrowthbyraceandethnicityandtenure/hh_race_tenure_db_2?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/demog-23.png")}
```
