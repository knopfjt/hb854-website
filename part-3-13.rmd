# Economic trends {#part-3-economic}
...
```{r econ-01, fig.cap="Change in total employment"}
if (knitr::is_html_output()) {
knitr::include_url(url = "https://public.tableau.com/views/HB854-Economic-Changeintotalemployment/emp_mg_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/econ-01.png")}
```
...
##### Large Metro Housing Markets---and some Small Metro Housing Markets---are still well below pre-pandemic employment levels. {.unlisted .unnumbered}

```{r econ-02, fig.cap="Pandemic job recovery"}
if (knitr::is_html_output()) {
knitr::include_url(url = "https://public.tableau.com/views/HB854-Economic-Changeintotalemployment/panjob_mg_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/econ-02.png")}
```
...
```{r econ-03, fig.cap="Unemployment rate by market name"}
if (knitr::is_html_output()) {
knitr::include_url(url = "https://public.tableau.com/views/HB854-Economic-Changeintotalemployment/emp_mn_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/econ-03.png")}
```
...
```{r econ-04, fig.cap="Unemployment rate by race and ethnicity"}
if (knitr::is_html_output()) {
knitr::include_url(url = "https://public.tableau.com/views/HB854-LAUSDemog/emp_race_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/econ-04.png")}
```
...
```{r econ-05, fig.cap="Ten most common jobs in Virginia in 2010 and 2020"}
if (knitr::is_html_output()) {
knitr::include_url(url = "https://public.tableau.com/views/HB854-Economic-TenmostcommonjobsinVirginiain2010and2020/occ_top_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/econ-05.png")}
```
...
```{r econ-06, fig.cap="Wages for top five fastest growing job sectors"}
if (knitr::is_html_output()) {
knitr::include_url(url = "https://public.tableau.com/views/HB854-Economic-Wagesfortopfivefastestgrowingjobsectors/occ_wage_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/econ-06.png")}
```
...
### Finding 3: Future jobs in Virginia will focus on computers, food, and healthcare. {.unlisted .unnumbered}

##### These important positions have a wide range of salaries. {.unlisted .unnumbered}

```{r econ-07, fig.cap="Job sectors with highest projected growth"}
if (knitr::is_html_output()) {
knitr::include_url(url = "https://public.tableau.com/views/HB854-Economic-Jobsectorswithhighestprojectedgrowth/occ_proj_top_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/econ-07.png")}
```
...
```{r econ-08, fig.cap="Average wage growth"}
if (knitr::is_html_output()) {
knitr::include_url(url = "https://public.tableau.com/views/HB854-Economic-Averagewagegrowth/wage_mg_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/econ-08.png")}
```
...
```{r econ-09, fig.cap="Average annual wage by industry"}
if (knitr::is_html_output()) {
knitr::include_url(url = "https://public.tableau.com/views/HB854-Economic-Averageannualwagebyindustry/wage_ind_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/econ-09.png")}
```
...
```{r econ-10, fig.cap="Median household incomes by race and ethnicity"}
if (knitr::is_html_output()) {
knitr::include_url(url = "https://public.tableau.com/views/HB854-Economic-Medianhouseholdincomesbyraceorethnicity/va_income_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/econ-10.png")}
```
...
```{r econ-11, fig.cap="Local median household incomes by race and ethnicity"}
if (knitr::is_html_output()) {
knitr::include_url(url = "https://public.tableau.com/views/HB854-Economic-Medianhouseholdincomesbyraceorethnicity/va_income_db2?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/econ-11.png")}
```
...
```{r econ-12, fig.cap="Household income distribution by tenure"}
if (knitr::is_html_output()) {
knitr::include_url(url = "https://public.tableau.com/views/HB854-Economic-Householdincomedistributionbytenure/income_dist_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/econ-12.png")}
```
...
### Finding 1: Black Virginians experience poverty at a disproportionately high rate. {.unlisted .unnumbered}

##### White and Asian Virginians have the lowest poverty rates. {.unlisted .unnumbered}

```{r econ-13, fig.cap="Poverty rate by race and ethnicity"}
if (knitr::is_html_output()) {
knitr::include_url(url = "https://public.tableau.com/views/HB854-Economic-Povertyratebyraceorethnicity/poverty_rate_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/econ-13.png")}
```
...
```{r econ-14, fig.cap="Poverty rate by age"}
if (knitr::is_html_output()) {
knitr::include_url(url = "https://public.tableau.com/views/HB854-Economic-Povertyratebyage/poverty_rate_age_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/econ-14.png")}
```
...
### Finding 3: Asset Limited, Income Constrained, Employed households are growing outside of Large Metro Housing Markets in Virginia. {.unlisted .unnumbered}
...
```{r econ-15, fig.cap="Asset Limited, Incomed Constrained, Employed (ALICE) households"}
if (knitr::is_html_output()) {
knitr::include_url(url = "https://public.tableau.com/views/HB854-Economic-ALICEhouseholdsinVirginia/va_alice_db?:showVizHome=no&:embed=true", height = "500px")
} else {knitr::include_graphics("img/econ-15.png")}
```
